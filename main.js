...
function preload() { ball_touch_paddel = loadSound("ball_touch_paddel.wav"); missed = loadSound("missed.wav"); }
...
function startGame()
{
  ...
  game_status = "start"; document.getElementById("status").innerHTML = "Game Is Loaded";
